import type { ProcessAccordionProps } from '@/domain/main/wokringProcess/components/workingProcessAccordion.tsx';

export const WorkingProcessSteps: Omit<ProcessAccordionProps, 'value'>[] = [
  {
    title: 'Consultation',
